        ...
        <title>MoneyPot</title>
			...
			<div className="relative h-full pt-10 sm:pt-0">
				<div className="p-6 sm:p-28 flex flex-col w-full sm:w-2/3 space-y-8 z-20">
					<h1 className="text-[#00FAE3] font-semibold text-3xl sm:text-6xl leading-snug">The moon is made <br />of Moneypot.</h1>
					<h6 className="text-[#C9D5F8] text-sm sm:text-2xl leading-snug pr-10">Trade, earn, and win crypto on the most popular decentralized platform in the galaxy.</h6>
				...
				<img className="hidden sm:block absolute bottom-0 right-0 left-0 z-10" src={moneypot_home} />
				<img className="block sm:hidden absolute bottom-0 right-0 left-0 z-10" src={moneypot_home_mobile} />
			</div>
    </div>
  )
}
